...
export function TicketWidget() {
	const [ticketDate, setTicketDate] = useSessionStorage<Date>('ticket-date', new Date());
	const [ticketData] = useSessionStorage<TicketType>('ticket-desc', initialStates.ticketDescription as TicketType);
	...
	return (
		<div className="mx-auto w-2/3 p-4">
			<div className="flex flex-wrap">
				...
				<div className="grow border border-l-black bg-white p-2 text-[#1E274A]">
					<TicketSelect totalAdults={totalAdults} setTotalAdults={setTotalAdults} setTotalKids={setTotalKids} />
				</div>
				<div className="grow border border-l-black bg-white p-2 text-[#1E274A]">
				...
				<div className="flex grow-[2] items-center justify-center rounded-r-lg bg-[#E52330] p-2">
					<Button className="hover:no-underline" variant="link" disabled={ticketData.totalAdults < 1}>
